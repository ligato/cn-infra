...
func TestSingleNode(t *testing.T) {
	...
	Expect(metaMap.ListAllNames()).To(Equal([]string{value1.Label()}))
	intMap := metaMap.(NameToInteger)
	metadata, exists := intMap.LookupByName(value1.Label())
	Expect(exists).To(BeTrue())
	Expect(metadata.GetInteger()).To(Equal(1))
	label, metadata, exists := intMap.LookupByIndex(1)
	Expect(exists).To(BeTrue())
	Expect(metadata.GetInteger()).To(Equal(1))
	Expect(label).To(Equal(value1.Label()))
	...
	Expect(record.ValueLabel).To(Equal(value1.Label()))
	Expect(record.ValueString).To(Equal(value1.String()))
	Expect(record.ValueType).To(Equal(value1.Type()))
...
func TestMultipleNodes(t *testing.T) {
	...
	metaMap := graphR.GetMetadataMap(metadataMapA)
	Expect(metaMap).ToNot(BeNil())
	checkMetadataValues(metaMap, value1.Label(), value2.Label(), value3.Label())
	intMap := metaMap.(NameToInteger)
	label, metadata, exists := intMap.LookupByIndex(1)
	Expect(exists).To(BeTrue())
	Expect(metadata.GetInteger()).To(Equal(1))
	...
	Expect(record.Since.Before(time.Now())).To(BeTrue())
	Expect(record.Until.IsZero()).To(BeTrue())
	Expect(record.ValueLabel).To(Equal(value2.Label()))
	Expect(record.ValueString).To(Equal(value2.String()))
	Expect(record.ValueType).To(Equal(value2.Type()))
	...
	Expect(record.Since.Before(time.Now())).To(BeTrue())
	Expect(record.Until.IsZero()).To(BeTrue())
	Expect(record.ValueLabel).To(Equal(value3.Label()))
	Expect(record.ValueString).To(Equal(value3.String()))
	Expect(record.ValueType).To(Equal(value3.Type()))
	Expect(record.Targets).To(HaveLen(1))
	Expect(record.Targets).To(HaveKey(relation2))
	...
	Expect(record.Since.Before(time.Now())).To(BeTrue())
	Expect(record.Until.IsZero()).To(BeTrue())
	Expect(record.ValueLabel).To(Equal(value4.Label()))
	Expect(record.ValueString).To(Equal(value4.String()))
	Expect(record.ValueType).To(Equal(value4.Type()))
	Expect(record.Targets).To(HaveLen(2))
	Expect(record.Targets).To(HaveKey(relation1))
	Expect(record.Targets[relation1]).To(HaveLen(1))
...
func TestNodeRemoval(t *testing.T) {
	...
	metaMap := graphR.GetMetadataMap(metadataMapA)
	Expect(metaMap).ToNot(BeNil())
	checkMetadataValues(metaMap, value1.Label(), value3.Label())
	intMap := metaMap.(NameToInteger)
	label, metadata, exists := intMap.LookupByIndex(1)
	Expect(exists).To(BeTrue())
	Expect(metadata.GetInteger()).To(Equal(1))
...
func TestNodeMetadata(t *testing.T) {
	...
	metaMap = graphR.GetMetadataMap(metadataMapA)
	Expect(metaMap).ToNot(BeNil())
	checkMetadataValues(metaMap, value2.Label(), value3.Label())
	intMap = metaMap.(NameToInteger)
	label, metadata, exists = intMap.LookupByIndex(1)
	Expect(exists).To(BeFalse())
	label, metadata, exists = intMap.LookupByIndex(2)
