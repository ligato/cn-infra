...
#./manual-partitioner -messageCount="0" -offsetMsg="1"
#./manual-partitioner -messageCount="0" -offsetMsg="70"
...
cmd="examples/kafka-plugin/post-init-consumer/post-init-consumer --kafka-config examples/kafka-plugin/hash-partitioner/kafka.conf -h"
testOutput "${cmd}" "${expected}"
